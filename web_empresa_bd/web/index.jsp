...
<html>
  ...
  <% 
                               ...
                               tblModelo =empleado.llenarEmpleado();
                                 ...
                                 out.println("<tr data-idestudiante="+ tblModelo.getValueAt(a,0).toString()  +" >");
                                ...
                                out.println("<td><i class='fa fa-pencil' aria-hidden='true' style='margin-left: 10px' ></i><i class='fa fa-trash' aria-hidden='true' style='margin-left: 20px'></i></td>");
                                out.println("</tr>");
                                          }
